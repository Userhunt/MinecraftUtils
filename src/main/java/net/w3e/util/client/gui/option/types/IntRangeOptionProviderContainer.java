...
public class IntRangeOptionProviderContainer<OBJECT> extends OptionProviderContainer<RangeOption<Integer, IntRangeOptionProviderContainer.IntRangeOption>, OBJECT, Integer> {
	...
	public IntRangeOptionProviderContainer(OptionProvider<?, OBJECT, ?, Integer> provider, OptionProviderContainer.ContainerPair<OBJECT> container, @SuppressWarnings("unused") Screen screen) {
