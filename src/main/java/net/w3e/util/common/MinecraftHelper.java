...
public class MinecraftHelper {
	...
	public static final ObjectWrapper<Quat, Quaternionf> QUAT_QUATERNIONF = new ObjectWrapper<>(Quat.class, Quaternionf.class, e -> new Quaternionf(e.xf(), e.yf(), e.zf(), e.wf()), e -> new QuatF(e.x(), e.y(), e.z(), e.w()));
